<div align="center" style="background-color: #0b0b0b; padding: 40px; border-radius: 12px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif;">
  ...
  <p>
    <a href="https://your-demo-link.com" style="text-decoration: none;">
      <button style="background-color: #4a4a4a; color: #ffffff; border: none; padding: 12px 24px; font-size: 16px; border-radius: 6px; cursor: pointer; margin-right: 10px;">
        View Demo
      </button>
    </a>
